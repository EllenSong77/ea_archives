...
if (git_get_option('git_cat_1')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_1')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_1')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
...
if (git_get_option('git_cat_2')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_2')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_2')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
    <div class="related_posts">
      <?php
      query_posts(array(
...
if (git_get_option('git_cat_3')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_3')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_3')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
    <div class="related_posts">
      <?php
      query_posts(array(
...
if (git_get_option('git_cat_4')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_4')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_4')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
    <div class="related_posts">
      <?php
      query_posts(array(
...
if (git_get_option('git_cat_5')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_5')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_5')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
    <div class="related_posts">
      <?php
      query_posts(array(
...
if (git_get_option('git_cat_6')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_6')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_6')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
    <div class="related_posts">
      <?php
      query_posts(array(
...
if (git_get_option('git_cat_7')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_7')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_7')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
    <div class="related_posts">
      <?php
      query_posts(array(
...
if (git_get_option('git_cat_8')) { ?>
  <div class="widget-title">
    <h2 class="title-h2"><small><?php
        echo get_cat_name(git_get_option('git_cat_8')); ?></small><span class="more" style="float:right;"><a
            style="left: 0px;" href="<?php
        echo get_category_link(git_get_option('git_cat_8')); ?>" title="阅读更多"
            target="_blank"><small>阅读更多</small></a></span></h2>
    <div class="related_posts">
      <?php
      query_posts(array(
