  ...
  <div id="respond" class="no_webshot">
    ...
    <?php } else { ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <div class="comt">
          <div class="comt-box">
            <textarea placeholder="<?php echo git_get_option('git_comment_placeholder', '说点什么吧……'); ?>"
                      class="input-block-level comt-area" name="comment" id="comment" cols="100%" rows="3" tabindex="1"
            ...
            <div class="comt-ctrl">
              <button class="btn btn-primary pull-right" type="submit" name="submit" id="submit" tabindex="5"><i
                    class="fa fa-check-square-o"></i> 提交评论
              </button>
