    ...
    <div class="article-content">
      ...
      $current_user = wp_get_current_user(); ?>">
        <div style="text-align: left; padding-top: 10px;">
          <p><label for="tougao_authorname">昵称:*</label></p><input style="width : 98%;" type="text" size="80" value=""
                                                                   id="tougao_authorname" name="tougao_authorname"/>
        </div>
        <div style="text-align: left; padding-top: 10px;">
          <p><label for="tougao_title">标题:*</label></p><input style="width : 98%;" type="text" size="80" value=""
                                                              id="tougao_title" name="tougao_title"/>
        </div>
        <div style="text-align: left; padding-top: 10px;">
          <p><label for="tougao_content">内容:*</label></p><textarea style="width : 98%;" name="tougao_content" rows="12"
                                                                   cols=""></textarea>
        </div>
        <div style="text-align: center; padding-top: 10px;">
          <input type="hidden" value="send" name="tougao_form"/>
          <input class="button" style="width:100px;height:30px;" type="submit" value="提交"/> &nbsp;&nbsp; <input
              style="width:100px;height:30px;" class="buttn" type="reset" value="重填"/>
        </div>
      </form>
      <br/>
      <?php
