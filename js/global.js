  ...
  c.extend(g, {
    ...
    _setDimension: function () {
      var a, b, d, e, f, h, i, j, k, l, n, q, r, s, t, u = g.getViewport(), v = 0, w = !1, x = !1, y = g.wrap,
        ...
        G = B.maxWidth, H = B.maxHeight, I = B.scrolling, J = B.scrollOutside ? B.scrollbarWidth : 0, K = B.margin,
        L = o(K[1] + K[3]), M = o(K[0] + K[2]);
    ...
    c.scrollbarWidth === d && (c.scrollbarWidth = function () {
      var a = c('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo("body"), b = a.children(),
      ...
      return a.remove(), b
    }()), c.extend(g.defaults, {scrollbarWidth: c.scrollbarWidth(), fixed: c.support.fixedPosition, parent: c("body")})
  })
    ...
    a(".toggle-search").click(function () {
      ...
      if (b = b || window.event, c = b.target || b.srcElement, e = a(c), !e.hasClass("disabled")) switch (e.parent().attr("data-type") && (e = a(e.parent()[0])), e.parent().parent().attr("data-type") && (e = a(e.parent().parent()[0])), g = e.attr("data-type")) {
        ...
        case"comment-insert-smilie":
          if (!a("#comment-smilies").length) {
            ...
            for (key in k.smilies) l += '<img data-simle="' + key + '" data-type="comment-smilie" src="' + _deel.url + "/css/img/smilies/icon_" + k.smilies[key] + '.gif">';
      ...
      return a(".comt-loading").show(), $submit.attr("disabled", !0).fadeTo("slow", .5), l && a("#comment").after('<input type="text" name="edit_id" id="edit_id" value="' + l + '" style="display:none;" />'), a.ajax({
        ...
        success: function (b) {
          ...
          var d = addComment, e = d.I("cancel-comment-reply-link"), f = d.I("wp-temp-form-div"), g = d.I(d.respondId),
      ...
      moveForm: function (c, d, e, f, g) {
        var h, i = this, j = i.I(c), k = i.I(e), m = i.I("cancel-comment-reply-link"), n = i.I("comment_parent"),
