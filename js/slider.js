jQuery.fn.wowSlider = function (aF) {
  ...
  ar("<div>").css({
    ...
    "font-size": 0,
    "line-height": 0
  }).append(be.find("li:first img:first").clone().css({width: "100%"})).prependTo(be);
  am.css({position: "absolute", top: 0, animation: "none", "-moz-animation": "none", "-webkit-animation": "none"});
  ...
  if ((/MSIE/.test(aP) && parseInt(/MSIE\s+([\d\.]+)/.exec(aP)[1], 10) < 8) || (/Safari/.test(aP))) {
    ...
    am.css({width: ay + "00%", display: "table"});
    a7.css({display: "table-cell", "float": "none", width: "auto"})
  }
  var aC = aF.onBeforeStep || function (a) {
    return a + 1
  };
  aF.startSlide = aH(isNaN(aF.startSlide) ? aC(-1, ay) : aF.startSlide);
  if (aW) {
    aW.load(aF.startSlide, function () {
    })
  }
  bd(aF.startSlide);
  var ap;
  ...
  function aV(b, a, d) {
    ...
    a4.trigger(ar.Event("go", {index: b}));
    aY(b);
    if (aF.caption) {
      aD(a7[b])
    }
  ...
  function aG(j, d, k, a, b) {
    ...
    if (j.addEventListener) {
      j.addEventListener("touchmove", function (l) {
        g = 1;
        if (e) {
      ...
      j.addEventListener("touchstart", function (l) {
        g = 0;
      ...
      j.addEventListener("touchend", function (l) {
        e = 0;
        if (a) {
          a(l)
        }
  ...
  if (!bc) {
    ...
    aN(ap ? ap.parentNode : be.get(0), function (b, a, d) {
  ...
  if (aF.controls) {
    ...
    a4.append(aM);
    a4.append(az);
    aM.bind("click", function (a) {
      ax(a, aA + 1)
    });
    az.bind("click", function (a) {
      ax(a, aA - 1)
    });
    if (/iPhone/.test(navigator.platform)) {
      az.get(0).addEventListener("touchend", function (a) {
        ax(a, aA - 1)
      }, false);
      aM.get(0).addEventListener("touchend", function (a) {
        ax(a, aA + 1)
      }, false)
    }
  }
  ...
  function bb() {
    ...
    if (ah.length) {
      ...
      var e = ah.find(">div");
      ah.css({overflow: "hidden"});
      var j;
      var d;
      var a;
      var m = a4.find(".ws_thumbs");
      m.bind("mousemove mouseover", function (u) {
        if (a) {
          return
        }
        clearTimeout(d);
        var s = 0.2;
        for (var v = 0; v < 2; v++) {
          var r = ah[v ? "width" : "height"](), w = e[v ? "width" : "height"](), z = r - w;
          if (z < 0) {
            ...
            e.animate(v ? {left: y} : {top: y}, x, f > 0 ? "linear" : "easeOutCubic")
          } else {
    ...
    if (a2.length) {
      ...
      if (l.length) {
        ...
        var n = ar("<div/>").css({width: l.length + 1 + "00%"}).appendTo(ar("<div/>").appendTo(k));
        l.appendTo(n);
        ar("<span/>").appendTo(k);
        var o = -1;
        ...
        function g(s) {
          ...
          var t = l.get(s);
          var u = {left: -t.offsetLeft + (ar(t).outerWidth(true) - ar(t).outerWidth()) / 2};
          if (o < 0) {
            k.css(r);
            n.css(u)
          } else {
  ...
  function ao(a) {
    ar("A", ah).each(function (d) {
      if (d == a) {
        ...
        if (!aq) {
          var g = ah.find(">div"), e = h.position() || {}, b = g.position() || {};
          g.stop(true).animate({
  ...
  if (aF.caption) {
    ...
    a4.append($caption);
    $caption.bind("mouseover", function (a) {
      aZ()
    });
    $caption.bind("mouseout", function (a) {
      au()
    })
  }
  var aI = function () {
  ...
  var W = {
    none: function (a, b) {
      ...
      W.array([{left1: "100%", top2: "100%"}, {left1: "80%", left2: "-50%"}, {
        top1: "-100%",
        top2: "100%",
        distance: 0.7,
        easing: "easeOutBack"
  ...
  function aD(d) {
    ...
    e.stop(1, 1).stop(1, 1).fadeOut(aF.captionDuration / 3, function () {
      if (a || b) {
        e.html((a ? "<span>" + a + "</span>" : "") + (b ? "<div>" + b + "</div>" : ""));
        var g = aF.captionEffect;
        (W[ar.type(g)] || W[g] || W[0])(g, e, aF.captionDuration)
      }
    })
  }
  ...
  function an(b, g) {
    ...
    if (e && e.getComputedStyle) {
      ...
      var h = g.replace(/\-\w/g, function (i) {
  ...
  function a1(h, b, l, e, j) {
    ...
    ar(i).css({position: "relative", visibility: "hidden"});
    h.show();
    for (var k in b) {
      if (/\%/.test(b[k])) {
    ...
    ar(i[0]).css({left: (b.left1 || 0) + "px", top: (b.top1 || 0) + "px"});
    ar(i[1]).css({left: (b.left2 || 0) + "px", top: (b.top2 || 0) + "px"});
    var j = b.duration || j;

    function g(n) {
      var m = ar(i[n]).css("opacity");
      ar(i[n]).css({visibility: "visible"}).css({opacity: 0}).animate({opacity: m}, j, "easeOutCirc").animate({
        top: 0,
        left: 0
      }, {duration: j, easing: (b.easing || e), queue: false})
    }
  ...
  function c(e, a) {
    var b = {position: 0, top: 0, left: 0, bottom: 0, right: 0};
    for (var k in b) {
      b[k] = e.get(0).style[k]
    }
    e.show();
    ...
    var l = ar("<div></div>").css({fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0});
    e.wrap(l);
    l = e.parent();
    if (e.css("position") == "static") {
      ...
      ar.extend(g, {position: e.css("position"), zIndex: e.css("z-index")});
      e.css({position: "absolute", top: 0, left: 0, right: "auto", bottom: "auto"})
    }
    l.css(g).show();
    ...
    var h = {};
    h[j] = (i ? "+=" : "-=") + m;
    l.animate({opacity: 1}, {duration: a.duration, easing: a.easing});
    e.animate(h, {
      queue: false, duration: a.duration, easing: a.easing, complete: function () {
        e.css(b);
  ...
  if (aF.stopOnHover) {
    this.bind("mouseover", function (a) {
      aZ();
      aw = true
    });
  ...
  au(1);
  var at = a4.find("audio").get(0), a6 = aF.autoPlay;
  if (at) {
    if (window.Audio && at.canPlayType && at.canPlayType("audio/mp3")) {
      ...
      swfobject.createSWF({data: T + "player_mp3_js.swf", width: "1", height: "1"}, {
...
function ws_cube(l, p, v) {
  var t = jQuery, r = t("ul", v), u = l.perspective || 2000;
  fullContCSS = {
    position: "absolute",
  ...
  var m = {
    domPrefixes: " Webkit Moz ms O Khtml".split(" "), testDom: function (a) {
      ...
      if (a && /AppleWebKit/.test(navigator.userAgent)) {
        var c = document.createElement("div"), b = document.createElement("style"),
  ...
  var s = (m.cssTransitions() && m.cssTransforms3d()), o = m.webkit();
  if (!s && l.fallback) {
  ...
  this.go = function (k, c) {
    function f(Q, O, N, P, S, T, R, V, W) {
      ...
      var X = Q.width(), L = Q.height();
      var U = t(Q.children().get(1));
      U.css({transform: "rotateY(0deg) rotateX(0deg)", boxShadow: n(X, L, 0, 0)});
      var M = t(Q.children().get(0));
      M.css({opacity: 1, transform: "rotateY(" + T + "deg) rotateX(" + S + "deg)", boxShadow: n(X, L, S, T)});
      if (o) {
        Q.css({transform: "translateZ(-" + O + "px)"})
      }
      var w = setTimeout(function () {
        var x = "all " + l.duration + "ms cubic-bezier(0.645, 0.045, 0.355, 1.000)";
        U.css({transition: x, boxShadow: n(X, L, R, V), transform: "rotateX(" + R + "deg) rotateY(" + V + "deg)"});
        M.css({transition: x, boxShadow: n(X, L, 0, 0), transform: "rotateY(0deg) rotateX(0deg)"});
    ...
    if (s) {
      ...
      r.hide();
      q = new f(h, d[0], d[1], d[2], d[3], d[4], d[5], d[6], function () {
        r.css({left: -k + "00%"}).show();
        h.remove();
        q = 0
      })
    } else {
      ...
      g.css({left: "auto", right: "auto", top: 0}).css(e, 0).show();
      r.hide();
      a.animate({width: "100%", left: 0}, l.duration, "easeInOutExpo", function () {
        t(this).remove()
      });
      j.animate({width: 0}, l.duration, "easeInOutExpo", function () {
        r.css({left: -k + "00%"}).show();
        g.remove()
      })
    }
