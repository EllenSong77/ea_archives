      ...
      while (have_posts()):
        ...
        <header class="article-header">
          ...
          <div class="meta">
            ...
            <span class="muted"><i class="fa fa-eye"></i> <?php
              deel_views('次浏览'); ?></span>
            <?php
            if (git_get_option('git_baidurecord_b') && function_exists('curl_init')) { ?><span class="muted"><i
                class="fa fa-flag"></i> <?php
            ...
            <?php
            if (git_get_option('git_qr_b') && !G_is_mobile()) { ?><span class="muted"><i class="fa fa-qrcode"></i> <a
                  style="cursor : pointer;" onMouseOver="document.all.qr.style.visibility=''"
                  onMouseOut="document.all.qr.style.visibility='hidden'">扫描二维码</a>
				<span id="qr" style="visibility: hidden;"><img style="position:absolute;z-index:99999;"
                                                       src="http://s.jiathis.com/qrcode.php?url=<?php
        ...
        <article class="article-content">
          ...
          <div class="article-social">
            ...
            if (isset($_COOKIE['bigfa_ding_' . $post->ID])) echo ' actived'; ?>"><i class="fa fa-heart-o"></i>喜欢 (<span
                  class="count"><?php
...
<span class="social-icon-wrap"><a class="as-img as-home" target="_blank" href="<?php
  the_author_meta('url'); ?>" title="作者主页"><i class="fa fa-home"></i>作者主页</a></span>
      ...
      <div id="donatecoffee" style="overflow:auto;display:none;"><img width="400px" height="400px"
                                                                      src="<?php echo git_get_option('git_pay_qr'); ?>">
      </div>
