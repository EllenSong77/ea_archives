...
<head>
  ...
  <script>
    ...
    (function () {
      ...
      hm.src = "https://hm.baidu.com/hm.js?85e45655042760fe348f380f8b368460";
...
echo git_get_option('git_customhead'); ?>') center 0px repeat-x;background-size: cover;background-repeat:repeat-x\9"
  ...
  if (!git_get_option('git_customhead')) { ?>
  <header style="background: url('<?php
  echo esc_url(get_template_directory_uri()); ?>/css/img/header.jpg') center 0px repeat-x;background-size: cover;"
          id="header" class="header">
    <?php
    } ?><?php
    } ?>
    ...
    <ul class="nav">
      ...
      <li style="float:right;">
        ...
        <?php
          ...
          echo home_url('/search/'); ?>' + encodeURIComponent(this.s.value).replace(/%20/g, '+'); return false;"
                action="/">
            <div><input type="ext" class="search" name="s" onblur="if(this.value=='')this.value='<?php
              echo git_get_option('git_search_placeholder', '输入内容并回车'); ?>';" onfocus="if(this.value=='<?php
              echo git_get_option('git_search_placeholder', '输入内容并回车'); ?>')this.value='';" value="<?php
  ...
  <section class="container">
    <div class="speedbar">
      ...
      <div class="toptip" id="callboard">
        <ul style="font-size:16px;margin-top: 2px;"><?php
